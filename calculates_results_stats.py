...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        if results_dic[key][3] == 1:   # Pet image is dog
            results_stats_dic['n_dogs_img'] += 1
            if results_dic[key][4] == 1:    #classified dog
                results_stats_dic['n_correct_dogs'] += 1
                
            #elif results_dic[key][2] == 1:   #mathches label
            if results_dic[key][0] in results_dic[key][1]:
                results_stats_dic['n_correct_breed'] += 1
       # elif results_dic[key][4] == 1        
        if results_dic[key][4] == 0 and results_dic[key][3] == 0:
            results_stats_dic['n_correct_notdogs'] += 1    
       
        if results_dic[key][2] == 1:    #mathches label
